...
# .env is in the backend directory (same level as migrations/)
...
# Import models metadata (but NOT db.database to avoid early connection)
from models.base import Base
from models import User, Profile, Plan, WorkoutLog, WellnessLog
